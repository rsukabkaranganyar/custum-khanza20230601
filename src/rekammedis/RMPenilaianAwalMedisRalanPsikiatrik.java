...
public final class RMPenilaianAwalMedisRalanPsikiatrik extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        GCS.setBackground(new java.awt.Color(255, 204, 204));
    ...
    private void isRawat() {
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "penilaian_awal_keperawatan_ralan_psikiatri.keluhan_utama,penilaian_awal_keperawatan_ralan_psikiatri.rkd_keluhan, " +
                    "penilaian_awal_keperawatan_ralan_psikiatri.td,penilaian_awal_keperawatan_ralan_psikiatri.suhu, " +
                    "penilaian_awal_keperawatan_ralan_psikiatri.rr,penilaian_awal_keperawatan_ralan_psikiatri.nadi,penilaian_awal_keperawatan_ralan_psikiatri.gcs " +
                    "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "left join penilaian_awal_keperawatan_ralan_psikiatri on penilaian_awal_keperawatan_ralan_psikiatri.no_rawat=reg_periksa.no_rawat "+ 
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    RPD.setText(rs.getString("rkd_keluhan"));
