    ...
    private void isRawat() {
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "penilaian_awal_keperawatan_kebidanan.td,penilaian_awal_keperawatan_kebidanan.nadi,penilaian_awal_keperawatan_kebidanan.rr," +
                    "penilaian_awal_keperawatan_kebidanan.suhu,penilaian_awal_keperawatan_kebidanan.gcs,penilaian_awal_keperawatan_kebidanan.bb," +
                    "penilaian_awal_keperawatan_kebidanan.tb,penilaian_awal_keperawatan_kebidanan.keluhan_utama "+ 
                    "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "left join penilaian_awal_keperawatan_kebidanan on penilaian_awal_keperawatan_kebidanan.no_rawat=reg_periksa.no_rawat "+  
