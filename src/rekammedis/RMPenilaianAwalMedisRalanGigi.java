...
public final class RMPenilaianAwalMedisRalanGigi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BB.setBackground(new java.awt.Color(255, 204, 204));
        ...
        RPK.setBackground(new java.awt.Color(255, 204, 204));
        RPK.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        RPK.setColumns(20);
        RPK.setRows(5);
        RPK.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-07-2023 14:50:15" }));
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Penilaian Awal Medis Rawat Jalan Gigi ]::");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ralan_gigi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",47,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                File f = new File("DataPenilaianAwalMedisRalanGigi.html");            
                            ...
                            "<table width='4200px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA PENILAIAN AWAL MEDIS RAWAT JALAN GIGI<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanGigi.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Gigi ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_gigi.tanggal,"+
                "penilaian_medis_ralan_gigi.kd_dokter,penilaian_medis_ralan_gigi.anamnesis,penilaian_medis_ralan_gigi.hubungan,penilaian_medis_ralan_gigi.keluhan_utama,"+
                "penilaian_medis_ralan_gigi.rps,penilaian_medis_ralan_gigi.rpk,penilaian_medis_ralan_gigi.alergi,penilaian_medis_ralan_gigi.keadaan,"+
                "penilaian_medis_ralan_gigi.kesadaran,penilaian_medis_ralan_gigi.nyeri,penilaian_medis_ralan_gigi.td,penilaian_medis_ralan_gigi.nadi,"+
                "penilaian_medis_ralan_gigi.suhu,penilaian_medis_ralan_gigi.rr,penilaian_medis_ralan_gigi.bb,penilaian_medis_ralan_gigi.tb,"+
                "penilaian_medis_ralan_gigi.status_nutrisi,penilaian_medis_ralan_gigi.kulit,penilaian_medis_ralan_gigi.keterangan_kulit,penilaian_medis_ralan_gigi.kepala,"+
                "penilaian_medis_ralan_gigi.keterangan_kepala,penilaian_medis_ralan_gigi.mata,penilaian_medis_ralan_gigi.keterangan_mata,penilaian_medis_ralan_gigi.leher,"+
                "penilaian_medis_ralan_gigi.keterangan_leher,penilaian_medis_ralan_gigi.kelenjar,penilaian_medis_ralan_gigi.keterangan_kelenjar,penilaian_medis_ralan_gigi.dada,"+
                "penilaian_medis_ralan_gigi.keterangan_dada,penilaian_medis_ralan_gigi.perut,penilaian_medis_ralan_gigi.keterangan_perut,penilaian_medis_ralan_gigi.ekstremitas,"+
                "penilaian_medis_ralan_gigi.keterangan_ekstremitas,penilaian_medis_ralan_gigi.wajah,penilaian_medis_ralan_gigi.intra,penilaian_medis_ralan_gigi.gigigeligi,"+
                "penilaian_medis_ralan_gigi.lab,penilaian_medis_ralan_gigi.rad,penilaian_medis_ralan_gigi.penunjang,penilaian_medis_ralan_gigi.diagnosis,"+
                "penilaian_medis_ralan_gigi.diagnosis2,penilaian_medis_ralan_gigi.permasalahan,penilaian_medis_ralan_gigi.terapi,penilaian_medis_ralan_gigi.tindakan,"+
                "penilaian_medis_ralan_gigi.edukasi,dokter.nm_dokter "+
    ...
    */
    ...
    private void isRawat() {
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "penilaian_awal_keperawatan_gigi.td,penilaian_awal_keperawatan_gigi.nadi,penilaian_awal_keperawatan_gigi.rr," +
                    "penilaian_awal_keperawatan_gigi.suhu,penilaian_awal_keperawatan_gigi.bb," +
                    "penilaian_awal_keperawatan_gigi.tb,penilaian_awal_keperawatan_gigi.keluhan_utama,penilaian_awal_keperawatan_gigi.alergi "+         
                    "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "left join penilaian_awal_keperawatan_gigi on penilaian_awal_keperawatan_gigi.no_rawat=reg_periksa.no_rawat "+           
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan_gigi","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,alergi=?,keadaan=?,kesadaran=?,nyeri=?,td=?,nadi=?,suhu=?,rr=?,bb=?,"+
